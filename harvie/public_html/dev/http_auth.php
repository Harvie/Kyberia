...
///SETTINGS////////////////////////////////////////////////////////////////////////////////////////////////////// 
//Login 
$realm = 'harvieho playground'; //This is used by browser to identify protected area and saving passwords (one_site+one_realm==one_user+one_password) 
$users = array(
	//user 	=> password,
	'harvie' => 'revyvoj',
	'demo' => 'demo',
...
////CODE///////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  function check_auth($PHP_AUTH_USER, $PHP_AUTH_PW) { //Check if login is succesfull (U can modify to use DB, or anything else) 
		return (isset($GLOBALS['users'][$PHP_AUTH_USER]) && ($PHP_AUTH_PW === $GLOBALS['users'][$PHP_AUTH_USER]));
  } 
