...
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	...
	<a href='/id/15/{$child.node_vector}'>k</a>, {if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}<a href='/id/{$child.node_id}/1961033'>configure</a>{/if})
...
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	&nbsp;article:: <a class='important' href='/id/{$child.node_id}'>{$child.node_name}</a>  :: {if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}(<a href='/id/{$child.node_id}/1961033'>configure</a>){/if} (<a href='/id/{$child.node_creator}'>{$child.login}</a>) <br>
{elseif $child.template_id eq 12}
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	&nbsp;data:: <a class='important' href='/id/{$child.node_id}'>{$child.node_name}</a>
	{if $node.node_creator eq $user_id or $node.node_permission eq 'master' or $node.node_permission eq 'op'}(<a href='/id/{$node.node_id}/1961033'>configure</a>){/if} (<a href='/id/{$child.node_creator}'>{$child.login}</a>)<br>
{elseif $child.template_id eq 14}
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	&nbsp;template:: <a class='important' href='/id/{$child.node_id}'>{$child.node_name}</a>  :: {if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}(<a href='/id/{$child.node_id}/1961033'>configure</a>){/if} (<a href='/id/{$child.node_creator}'>{$child.login}</a>) (<br>
...
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	&nbsp;rss_bot:: <a class='important' href='/id/{$child.node_id}'>{$child.node_name}</a> :: {if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}(<a href='/id/{$child.node_id}/1961033'>configure</a>){/if} (<a href='/id/{$child.node_creator}'>{$child.login}</a>) <br>

{elseif $child.template_id eq $child.node_id}
<input style='height: 11px; width: 11px;' type='checkbox' value='{$child.node_id}' name='node_chosen[]'>&nbsp;
	&nbsp;tpl:: <a class='important' href='/id/{$child.node_id}'>{$child.node_name}</a> :: (<a href='/id/{$child.node_id}/14'>code</a>{if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}|<a href='/id/{$child.node_id}/1961033'>configure</a>{/if}) (<a href='/id/{$child.node_creator}'>{$child.login}</a>) <br>
...
<input style='height: 11px; width: 11px;' type='checkbox' value='{$link.node_id}' name='node_chosen[]'>&nbsp;
	...
	(<a href='/id/{$link.synapse_creator}'>{$link.login}</a>) ({if $child.node_creator eq $user_id or $child.node_permission eq 'master' or $child.node_permission eq 'op'}<a href='/id/{$child.node_id}/1961033'>configure</a>{/if})<br>
{/foreach}
