...
<tr><td><input type='text' name='listing_amount' value='{$listing_amount}'></td><td><input type='submit' name='event' value='set_listing_amount'></td><
...
<!-- NAJ.sk -->
<noscript>
<img src="http://www.naj.sk/hit?id=10686;n=1" width="1" height="1" alt="" border="0">
</noscript>
<!-- NAJ.sk - konec -->
