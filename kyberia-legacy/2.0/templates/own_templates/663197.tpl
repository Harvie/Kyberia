...
<tr><td>get_get_nodes_by_type type=5 vector=;1;103 listing_amount=23 offset=$offset</td><td>{get_nodes_by_type type=5 vector=;1;103 listing_amount=23 offset=$offset}</td></tr>
</table>
