...
<br><br>
<form action='/id/{$k.node_id}' method='post'><input type='submit' name='event' value='K' style='position: static;'></form>

</td>
<td class='header' width='100%'><a href='/id/{$k.node_id}/'>{$k.node_name}</a>
 in <a href='/id/{$k.node_parent}'>{$k.parent_name}</a> by <a href='/id/{$k.node_creator}'>{$k.creator}</a>
</td>
