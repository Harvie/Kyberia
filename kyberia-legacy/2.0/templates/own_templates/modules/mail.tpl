...
{get_mail listing_amount=23232322323 offset=$offset search_type=$post_vars.search_type search=$post_vars.mail_text}
...
{elseif $message.mail_read eq 'no' and $message.mail_to neq $message.mail_user}<span class='most_important'>UNDELIVERED</span>{/if}
&nbsp&nbsp;{$message.mail_timestamp|date_format:"%H:%M:%S - %d.%m.%Y"}
</td>
</tr>
<tr>
<td valign='top'>{$message.mail_text|nl2br}</td>
</tr>
</table>
{/foreach}
